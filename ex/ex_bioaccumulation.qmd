...
US EPA [Description of Bioaccumulation Model](https://www.epa.gov/pesticide-science-and-assessing-pesticide-risks/kabam-version-10-users-guide-and-technical-7)
...
$$ V_t = V_0 e^{-(K+G) \cdot t} \, \frac{U\cdot C,\alpha \cdot C_j \cdot W_j}{K\,+\,G}\left( 1 - e^{-(K+G) \cdot t}\right)$$ 
och vad de olika variablerna betyder kan ni se i tabellen här.
