...
Simple box was briefly shown in the lecture. 
...
Add your answers to the questions and main discussion points to the report that you submit to canvas. You are expected to combine the answers to this exercise and the environmental exposure database exercise into one report. Put your name on the report! 
...
I get mass 6.7 kg and concentration 1.4e-7 g.kg(w)-1. Do you get the same? 
...
I see that the mass in freshwater sediment is 0.7% of the total concentration in the system. Do you get the same? 

(@) Were do the majority of the caffeine end up at steady state? 

I see that 81.1% of the mass of caffeine is in open freshwater. Do you get the same
