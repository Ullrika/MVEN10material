...
Add your your answers to the questions and main discussion points to the report that you then submit to canvas. You are expected to combine the answers to this exercise and the environmental exposure assessment exercise into one report. Put your name on the report! 
...
(@) Goto Table 5-3 and extract a high exposure to Aluminium via soil and dust combined for a child between 1 to 4 years old. 
...
(@) Enter the foodex2-level-1 window. If it doesnt work, try another web browser (chrome does not seem to work. Firefox and explorer works)

(@) Filter the data (see tab to the right). Select (All) in Exposure hierarchy L1 - this action deselects all. Then select **Coffee, cocoa, tea and infusions** only

![](../img/food1.png)

(@) Discuss the difference between the chronic vs acute

(@) Discuss the difference between consumers only vs all subjects
...
(@) Discuss how to define a high consumer and how to derive the estimate. Report back how you motivate your suggestion and the derived estimate.
