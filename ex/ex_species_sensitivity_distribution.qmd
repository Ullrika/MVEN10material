...
- Compare to the numbers 0.72 and 0.107 - this is the model average and lower uncertainty bound from a SSD using the full data set

- Compare to a hazardous concentration derived from two species and an approripriate assessment factor. Here you shall look at your data and select two data points. Select assessment factor from the table in the beginning of this document. 
