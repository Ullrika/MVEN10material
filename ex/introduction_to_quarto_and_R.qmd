...
(@) Install ggplot2 by typing **install.packages("tidyverse")** in the R Console. This installs several packages including ggplot2 that you will use later on. R-packages are libraries with functions and data sets designed for a specific purpose. Note that you will only have to do this one time in your work space. 
