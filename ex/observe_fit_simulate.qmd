...
You are to use R to fit a probability distribution to the observations from all four groups. 
...
We have previously looked how to generate random samples from a probability distribution. Next time we will simulate from your fitted distributions. 
